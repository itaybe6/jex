...
const styles = StyleSheet.create({
  ...
  avatar: { width: 36, height: 36, borderRadius: 18, marginRight: 10, backgroundColor: '#E3EAF3' },
  sellerName: { fontSize: 15, color: '#0E2657', fontFamily: 'Montserrat-Medium' },
  timeAgo: { fontSize: 13, fontFamily: 'Montserrat-Regular', color: '#7B8CA6', marginLeft: 8 },
  requestsContainer: {
    padding: 16,
  },
  requestCard: {
